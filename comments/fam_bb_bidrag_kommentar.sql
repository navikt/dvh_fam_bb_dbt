...
COMMENT ON COLUMN DVH_FAM_BB.FAM_BB_BIDRAG.FORSTE_VEDTAKSTIDSPUNKT IS'#NAVN FORSTE_VEDTAKSTIDSPUNKT #INNHOLD Tidspunkt for når første vedtaket i en sak ble fattet';-----------------
...
COMMENT ON COLUMN DVH_FAM_BB.FAM_BB_BIDRAG.belop IS'#NAVN BELOP #INNHOLD Beløp bergenet til NOK ved bruk av valutakurs fra Norges Bank';-----------------
COMMENT ON COLUMN DVH_FAM_BB.FAM_BB_BIDRAG.BELOP_VEDTAK IS'#NAVN BELOP_VEDTAK #INNHOLD Sum beløp som er utbetalt til mottaker fra skyldner, innholder andre valuter enn NOK';
